...
for Nfold in range(nsplits-1,nsplits+1-1):
    ...
    #kern = gpflow.kernels.Matern12(lengthscales=list(np.random.rand(Xtrain.shape[1])))+gpflow.kernels.White(1e-9)
    kern = gpflow.kernels.RBF(lengthscales=list(np.random.rand(Xtrain.shape[1]))) + gpflow.kernels.White(1e-9)
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    model = gpflow.models.GPR(data=(Xtrain, Ytrain), kernel=kern, mean_function=None)
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    np.random.seed(myseed)
    ...
    #opt = gpflow.optimizers.Scipy('LBFGS')
    opt_logs = opt.minimize(model.training_loss, model.trainable_variables, options=dict(maxiter=int(config.N_iter_epoch)))
    print_summary(model)

    mean, var = model.predict_f(Xval)
