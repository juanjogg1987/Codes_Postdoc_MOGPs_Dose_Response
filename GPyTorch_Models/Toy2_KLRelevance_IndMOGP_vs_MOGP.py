...
x5 = 0.1*np.random.randn(x1.shape[0])
...
if generative =="ICM":
    ...
    k1.lengthscale = 0.05 #1.2#2.0
    k2.lengthscale = 0.05#0.03#1.3
    k3.lengthscale = 0.05#0.5#0.8
    k4.lengthscale = 0.05#0.07#0.1
else:
    print("Generative LMC")
    k1.lengthscale = 0.9#2.0
    k2.lengthscale = 0.03#1.3
    k3.lengthscale = 0.3#0.8
    k4.lengthscale = 0.07#0.1
...
Yall = F + 0.1*np.random.randn(x1.shape[0],Dtasks)
Ntrain = Nall//3
...
Xval = Xall[index_N[2*Ntrain:],:].copy()
Yval = Yall[index_N[2*Ntrain:],:].copy()
Yclean = F[index_N[2*Ntrain:],:].copy()
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"SEED"
torch.manual_seed(30)  #it was 30
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
import os
...
likelihood = gpytorch.likelihoods.MultitaskGaussianLikelihood(num_tasks=num_tasks,noise_constraint=gpytorch.constraints.Interval(1.0e-6,1.0e-2),rank=num_tasks)
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
