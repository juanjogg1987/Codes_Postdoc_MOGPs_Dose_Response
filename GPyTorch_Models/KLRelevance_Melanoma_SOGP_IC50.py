...
for Nfold in range(nsplits,nsplits+1):
    ...
    state_dict = torch.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPyTorch_Models/FiveCancersDataSet/Best_Model_Melanoma_SOGP_IC50/m_' + m_trained + '.pth')
    # state_dict = torch.load("/home/ac1jjgg/MOGP_GPyTorch/FiveCancersDataSet/Best_Model_Melanoma_SOGP_IC50/" +'m_'+ m_trained + '.pth')
