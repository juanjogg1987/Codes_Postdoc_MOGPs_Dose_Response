...
which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevances_Melanoma/'
if not os.path.exists(path_to_save):
    os.makedirs(path_to_save)


"The winner model should be loaded as"
"KLRelevance_Melanoma_ExactMOGP.py -i 0 -s 3.0000 -k 4 -r 1016 -d 2 -p 485 -e %d"
...
for count in range(385):
    ...
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPyTorch/KLRelevance_Melanoma_ExactMOGP.py -i 0 -s 3.0000 -k 4 -r 1016 -d 2 -p 485 -e %d" % (
                ram, count))
