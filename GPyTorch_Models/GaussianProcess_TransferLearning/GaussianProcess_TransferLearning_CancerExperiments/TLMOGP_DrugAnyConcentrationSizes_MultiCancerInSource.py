...
class commandLine:
    def __init__(self):
        ...
        self.which_seed = 33 #35   #change seed to initialise the hyper-parameters
...
indx_cancer_train = np.array([1,2,3,4])
...
df_source = df_all.dropna().sample(n=300,random_state = 4)
