...
path_to_save = './bash_torchjobs_MelanomaGDSC2_IndMOGP/'
        ...
        for d in spli_dim:
            ...
            if which_HPC == 'sharc' and count%1 == 0:
                f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                        "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPyTorch/Codes_for_GDSC2/All_Drugs_MelanomaGDSC2_GPyTorch_IndMOGP.py -i 1500 -s %.4f -r %d -d %d -p %d" % (
