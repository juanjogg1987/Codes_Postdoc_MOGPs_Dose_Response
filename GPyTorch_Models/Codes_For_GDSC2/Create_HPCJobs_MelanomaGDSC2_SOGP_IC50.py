...
path_to_save = './bash_torchjobs_MelanomaGDSC2_SOGP_IC50/'
        ...
        for d in spli_dim:
            ...
            if which_HPC == 'sharc' and count%1 == 0:
                f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                        "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/SOGP_GPyTorch/Codes_for_GDSC2/All_Drugs_MelanomaGDSC2_GPyTorch_SOGP_IC50.py -i 1200 -s %.4f -r %d -d %d -p %d" % (
