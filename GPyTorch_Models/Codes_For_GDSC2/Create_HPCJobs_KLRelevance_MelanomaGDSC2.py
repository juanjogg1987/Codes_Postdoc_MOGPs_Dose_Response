...
which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevances_MelanomaGDSC2/'
if not os.path.exists(path_to_save):
    os.makedirs(path_to_save)


"The winner model should be loaded as"
"KLRelevance_MelanomaGDSC2_ExactMOGP -i 1500 -s 0.1000 -k 6 -r 1016 -d 2 -p 440 -e %d"
...
for count in range(419):
    ...
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPyTorch/Codes_for_GDSC2/KLRelevance_MelanomaGDSC2_ExactMOGP.py -i 0 -s 0.1000 -k 6 -r 1016 -d 2 -p 440 -e %d" % (
                ram, count))
