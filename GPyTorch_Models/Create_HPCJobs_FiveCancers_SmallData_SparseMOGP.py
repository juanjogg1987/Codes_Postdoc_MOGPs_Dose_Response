...
path_to_save = './bash_torchjobs_FiveCancers_SparseMOGP/'
                        ...
                        for d in spli_dim:
                            ...
                            if which_HPC == 'sharc' and count%1 == 0:
                                f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                                        "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPyTorch/All_Drugs_FiveCancers_SmallData_GPyTorch_SparseMOGP.py -l %d -b %d -m %d -i 50 -w %.4f -s %.4f -r %d -d %d -p %d" % (
                                        ram, l, minbatch, m, w, s, myseed,d,count))
