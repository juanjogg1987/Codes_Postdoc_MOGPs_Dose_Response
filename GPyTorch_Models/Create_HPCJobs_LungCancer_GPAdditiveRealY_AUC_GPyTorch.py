...
path_to_save = './bash_torchjobs_AdditiveCorrectRealY_AUC/'
                ...
                for myfold in Nfold:
                    ...
                    if which_HPC == 'sharc' and count%1 == 0:
                        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/SOGP_GPyTorch/All_Drugs_LungCancer_GPAdditiveRealY_AUC_GPyTorch.py -b %d -m %d -i 40 -s %.4f -r %d -d %d -p %d -f %d" % (
