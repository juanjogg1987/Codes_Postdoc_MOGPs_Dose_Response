...
which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevances_Melanoma_SOGP_IC50/'
if not os.path.exists(path_to_save):
    os.makedirs(path_to_save)


"The winner model should be loaded as"
"KLRelevance_Melanoma_SOGP_IC50.py -i 1200 -s 0.0100 -r 1011 -d 5 -p 21 -e %d"
"KLRelevance_Melanoma_SOGP_IC50.py -i 1200 -s 0.0100 -r 1015 -d 5 -p 61 -e %d"
"KLRelevance_Melanoma_SOGP_IC50.py -i 1200 -s 0.0100 -r 1016 -d 5 -p 81 -e %d"

"just the -e should be the iterable over the P features"
for count in range(385):
    f = open(path_to_save + "bash" + str(count) + ".sh", "w+")
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/SOGP_GPyTorch/KLRelevance_Melanoma_SOGP_IC50 -i 0 -s 0.0100 -r 1011 -d 5 -p 21 -e %d" % (
                ram, count))
