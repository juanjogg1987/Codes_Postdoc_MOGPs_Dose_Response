...
seeds = [1010,1011,1012,1015,1016]
...
path_to_save = './bash_torchjobs_Melanoma_ExactMOGP/'
            ...
            for d in spli_dim:
                ...
                if which_HPC == 'sharc' and count%1 == 0:
                    f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                            "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPyTorch/All_Drugs_Melanoma_GPyTorch_ExactMOGP.py -i 1500 -s %.4f -k %d -r %d -d %d -p %d" % (
                            ram, scale, rank,myseed,d,count))
