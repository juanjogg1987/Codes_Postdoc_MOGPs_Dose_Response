...
class commandLine:
    def __init__(self):
        opts, args = getopt.getopt(sys.argv[1:], 'i:s:k:w:r:d:p:')
        # opts = dict(opts)
        # print(opts)
...
#
# #final_path = '/data/ac1jjgg/Data_Marina/GPy_results/Codes_for_GDSC2/MelanomaGDSC2_SmallDataset_ExactMOGP_AddKern/'
# final_path ='model_MelanomaGDSC2_ExactMOGP_AddKern/'
