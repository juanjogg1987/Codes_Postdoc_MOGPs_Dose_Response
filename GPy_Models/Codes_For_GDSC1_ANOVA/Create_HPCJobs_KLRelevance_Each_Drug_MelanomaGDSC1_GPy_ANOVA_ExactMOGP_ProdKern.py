...
if config.drug_name == "1061":
    drug_setting = "-i 1500 -s 1.0000 -k 2 -w 1.0000 -r 1014 -p 505 -d 1061"
elif config.drug_name == "1373":
    drug_setting = "-i 1500 -s 1.0000 -k 2 -w 1.0000 -r 1013 -p 221 -d 1373"
elif config.drug_name == "1036":
    drug_setting = "-i 1500 -s 3.0000 -k 2 -w 0.0100 -r 1018 -p 946 -d 1036"
else:
    print(f"The drug {config.drug_name} has not been tested")

which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevance_Drug'+config.drug_name+'_GPy_ANOVA_MelanomaGDSC1_ProdKern/'
...
for count in range(Pfeatures):
    ...
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1_ANOVA/KLRelevance_Each_Drug_MelanomaGDSC1_GPy_ANOVA_ExactMOGP_ProdKern.py %s -e %d" % (
