...
for Nfold in range(0,nsplits+1):
    ...
    #model.optimize(optimizer='lbfgsb',messages=True,max_iters=20)
...
final_path = '/data/ac1jjgg/Data_Marina/GPy_results/Codes_for_GDSC1/Drugs_1036_and_1371_MelanomaGDSC1_SmallDataset_ExactMOGP_ToPredict_MelanomaGDSC2/'
#final_path ='model_Drugs_1036_and_1371_MelanomaGDSC1_SmallDataset_ExactMOGP_ToPredict_MelanomaGDSC2/'
...
Ylabel_test_Dose7 = np.array([i * np.ones(Xtest_aux_Dose7.shape[0]) for i in range(Ntasks7)]).flatten()[:, None]
Xtest_GDSC2_Dose7 = np.concatenate((np.tile(Xtest_aux_Dose7, (Ntasks7, 1)), Ylabel_test_Dose7), 1)
...
m_pred_curve_Dose7 = m_pred_Dose7.reshape(Ntasks7, Nval_Dose7).T.copy()
v_pred_curve_Dose7 = v_pred_Dose7.reshape(Ntasks7, Nval_Dose7).T.copy()

"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"Interpolation of predictions for GDSC2 for Dose7"
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

x_dose_Dose7 = np.linspace(0.111111, 1.0, 7)  # Here 5 due to having 5 dose responses
