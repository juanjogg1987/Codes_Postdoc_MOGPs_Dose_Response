    ...
    for cell_k,N_cells in enumerate(N_CellLines):
        for Seed_N in Seeds_for_NCells:
            ...
            try:
                ...
                _FOLDER_Cancer_csv_test = '/data/ac1jjgg/Data_Marina/GPy_results/Codes_for_GDSC2_5Cancers/Three_drugs/Cancer_'+str(Sel_cancer)+'/'+'N'+str(N_cells)+'/seed'+str(Seed_N)+'/'
...
with open('Test_Metrics_To_Plot_Three_drugs.pkl', 'wb') as f:
