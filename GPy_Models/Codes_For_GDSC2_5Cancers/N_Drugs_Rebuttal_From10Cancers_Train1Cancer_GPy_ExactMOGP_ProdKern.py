...
dict_cancers={0:'GDSC2_10drugs_SKCM_1000FR.csv',1:'GDSC2_10drugs_SCLC_1000FR.csv',
              2:'GDSC2_10drugs_PAAD_1000FR.csv',3:'GDSC2_10drugs_OV_1000FR.csv',4:'GDSC2_10drugs_LUAD_1000FR.csv',
              5:'GDSC2_10drugs_HNSC_1000FR.csv',6:'GDSC2_10drugs_ESCA_1000FR.csv',7:'GDSC2_10drugs_COAD_1000FR.csv',
...
Nd4,Nd5,Nd6 = round(N_per_drug_Tr[3]*N_CellLines_perc/100.0),round(N_per_drug_Tr[4]*N_CellLines_perc/100.0),round(N_per_drug_Tr[5]*N_CellLines_perc/100.0)
Nd7,Nd8,Nd9 = round(N_per_drug_Tr[6]*N_CellLines_perc/100.0),round(N_per_drug_Tr[7]*N_CellLines_perc/100.0),round(N_per_drug_Tr[8]*N_CellLines_perc/100.0)
Nd10 = round(N_per_drug_Tr[9]*N_CellLines_perc/100.0)
df_4Cancers_train = pd.concat([df_4Cancers_train_d1.sample(n=Nd1,random_state = rand_state_N), df_4Cancers_train_d2.sample(n=Nd2,random_state = rand_state_N),
                               df_4Cancers_train_d3.sample(n=Nd3,random_state = rand_state_N), df_4Cancers_train_d4.sample(n=Nd4,random_state = rand_state_N),
                               df_4Cancers_train_d5.sample(n=Nd5,random_state = rand_state_N),df_4Cancers_train_d6.sample(n=Nd6,random_state = rand_state_N),
                               df_4Cancers_train_d7.sample(n=Nd7,random_state = rand_state_N),df_4Cancers_train_d8.sample(n=Nd8,random_state = rand_state_N),
                               df_4Cancers_train_d9.sample(n=Nd9,random_state = rand_state_N),df_4Cancers_train_d10.sample(n=Nd10,random_state = rand_state_N)])
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"Testing data"
