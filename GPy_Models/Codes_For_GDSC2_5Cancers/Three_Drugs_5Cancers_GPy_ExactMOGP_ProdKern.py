...
class commandLine:
    def __init__(self):
        ...
        self.weight = 1
        self.bash = "1"
        self.N_CellLines = 200   #Try to put this values as multiple of Num_drugs
        self.sel_cancer = 0
        self.seed_for_N = 5
...
#     """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
#
# # path_cancer = './Three_drugs/Cancer_'+str(config.sel_cancer)+'/N'+str(N_CellLines)+'/seed'+str(rand_state_N)+'/'
