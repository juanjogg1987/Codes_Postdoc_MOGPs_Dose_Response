...
Num_drugs = 3
N_CellLines = int(config.N_CellLines)//Num_drugs
...
for i in range(0,4):
    ...
    if i==0:
        ...
        Nd1,Nd2,Nd3 = np.clip(N_CellLines,1,N_per_drug[0]),np.clip(N_CellLines,1,N_per_drug[1]),np.clip(N_CellLines,1,N_per_drug[2])
...
path_cancer = './Cancer_'+str(config.sel_cancer)+'/N'+str(N_CellLines)+'/seed'+str(rand_state_N)+'/'
...
#final_path = '/data/ac1jjgg/Data_Marina/GPy_results/Codes_for_GDSC2_5Cancers/Three_drugs/Cancer_'+str(config.sel_cancer)+'/N'+str(config.N_CellLines)+'/seed'+str(rand_state_N)+'/'
final_path ='Models_5Cancers/Three_drugs/Cancer_'+str(config.sel_cancer)+'/N'+str(config.N_CellLines)+'/seed'+str(rand_state_N)+'/'
