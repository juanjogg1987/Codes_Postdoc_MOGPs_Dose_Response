...
path_to_save = './bash_Cancer'+str(Test_cancers[0])+'_GPyjobs_N_Drugs_5Cancers_GPy_ExactMOGP_ProdKern_N5thCancer_'+str(N_5thCancer)+'/'
                        ...
                        for sel_cancer in Test_cancers:
                            ...
                            if which_HPC == 'sharc' and count%1 == 0:
                                f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                                        "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_5Cancers/N_Drugs_5Cancers_GPy_ExactMOGP_ProdKern.py -i 1500 -s %.4f -k %d -w %.4f -r %d -p %d -c %d -a %d -n %d -t %d" % (
