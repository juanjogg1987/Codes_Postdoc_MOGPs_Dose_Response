...
AUC_per_cell,Emax_per_cell,IC50_per_cell,AUCR2_per_cell,EmaxR2_per_cell,IC50R2_per_cell,AUC_CV_per_cell,Emax_CV_per_cell,IC50_CV_per_cell = np.load(path_to_load+'Test_Metrics_To_Plot_Three_drugs.pkl',allow_pickle=True)
...
myplot_fillbetween(axs,[0,0],N_Cells_lin,f_meanAUC,f_stdAUC,title='AUC-Interpolated '+cancer,ylabel = True,ylim=[0.04,0.13])
myplot_fillbetween(axs,[1,0],N_Cells,AUC_mean,AUC_std,title='AUC '+cancer,ylabel = True,ylim=[0.04,0.13])
myplot_fillbetween(axs,[0,1],N_Cells_lin,f_meanEmax,f_stdEmax,title='Emax-Interpolated '+cancer,ylabel = True,ylim=[0.1,0.17])
myplot_fillbetween(axs,[1,1],N_Cells,Emax_mean,Emax_std,title='Emax '+cancer,ylabel = True,ylim=[0.1,0.17])
myplot_fillbetween(axs,[0,2],N_Cells_lin,f_meanIC50,f_stdIC50,title='IC50-Interpolated '+cancer,ylabel = True,ylim=[0.0073,0.0343])
myplot_fillbetween(axs,[1,2],N_Cells,IC50_mean,IC50_std,title='IC50 '+cancer,ylabel = True,ylim=[0.0073,0.0343])

fig, axs1 = plt.subplots(2, 3,figsize = (15,10))
myplot_fillbetween(axs1,[0,0],N_Cells_lin,f_meanAUC_CV,f_stdAUC_CV,title='Validation AUC-Interp. ('+cancer+' Non-Data in Train)',ylabel = True,ylim=[0.04,0.095])
myplot_fillbetween(axs1,[1,0],N_Cells,AUC_CV_mean,AUC_CV_std,title='Validation AUC ('+cancer+' Non-Data in Training)',ylabel = True,ylim=[0.04,0.095])
myplot_fillbetween(axs1,[0,1],N_Cells_lin,f_meanEmax_CV,f_stdEmax_CV,title='Validation Emax-Interp. ('+cancer+' Non-Data in Train)',ylabel = True,ylim=[0.1,0.17])
myplot_fillbetween(axs1,[1,1],N_Cells,Emax_CV_mean,Emax_CV_std,title='Validation Emax ('+cancer+' Non-Data in Training)',ylabel = True,ylim=[0.1,0.17])
myplot_fillbetween(axs1,[0,2],N_Cells_lin,f_meanIC50_CV,f_stdIC50_CV,title='Validation IC50-Interp. ('+cancer+' Non-Data in Train)',ylabel = True,ylim=[0.04,0.13])
myplot_fillbetween(axs1,[1,2],N_Cells,IC50_CV_mean,IC50_CV_std,title='Validation IC50 ('+cancer+' Non-Data in Training)',ylabel = True,ylim=[0.04,0.13])
