...
for sel_cancer in cancers:
    ...
    if AE_AUC_Res_Ncells[0].shape[0] != 0:
        plot_Nth_dose(sel_cancer, axs2, 1, Num_cells, AE_AUC_Res_Ncells, MAE_AUC_Res_Ncells,my_ylim=[-0.01,0.6],my_title="AUC Responsive (AE)")
        if data_AUC_Res[sel_cancer].shape[0] != 0:
            plot_benchmark(axs2, [sel_cancer, 0], N_Cells_lin, data_AUC_Res[sel_cancer],alpha=0.5)
    plot_Nth_dose(sel_cancer, axs2, 2, Num_cells, AE_AUC_NoRes_Ncells, MAE_AUC_NoRes_Ncells,my_ylim=[-0.01,0.6],my_title="AUC Non-Responsive (AE)")
    ...
    if AE_Emax_Res_Ncells[0].shape[0] != 0:
        plot_Nth_dose(sel_cancer, axs2, 3, Num_cells, AE_Emax_Res_Ncells, MAE_Emax_Res_Ncells,my_ylim=[-0.01,0.6],my_title="Emax Responsive (AE)")
        if data_Emax_Res[sel_cancer].shape[0] != 0:
            plot_benchmark(axs2, [sel_cancer, 2], N_Cells_lin, data_Emax_Res[sel_cancer],alpha=0.5)
    plot_Nth_dose(sel_cancer, axs2, 4, Num_cells, AE_Emax_NoRes_Ncells, MAE_Emax_NoRes_Ncells,my_ylim=[-0.01,0.6],my_title="Emax Non-Responsive (AE)")
    ...
    if AE_IC50_Res_Ncells[0].shape[0] != 0:
        plot_Nth_dose(sel_cancer, axs2, 5, Num_cells, AE_IC50_Res_Ncells, MAE_IC50_Res_Ncells, my_ylim=[-0.01, 0.6],my_title="IC50 Responsive (SE)")
        plot_benchmark(axs2, [sel_cancer, 4], N_Cells_lin, data_IC50_Res[sel_cancer],alpha=0.5)
    plot_Nth_dose(sel_cancer, axs2, 6, Num_cells, AE_IC50_NoRes_Ncells, MAE_IC50_NoRes_Ncells, my_ylim=[-0.01, 0.6],my_title="IC50 Non-Responsive (SE)")
