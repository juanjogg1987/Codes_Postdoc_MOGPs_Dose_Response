...
for Sel_cancer in sel_cancers:
    for cell_k,N_cells in enumerate(N_CellLines):
        for Seed_N in Seeds_for_NCells:
            #Sel_cancer = 3
            _FOLDER_Cancer = '/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_5Cancers/bash_Cancer'+str(Sel_cancer)+'_GPyjobs_All_Drugs_5Cancers_GPy_ANOVA_ExactMOGP_ProdKern/Cancer_'+str(Sel_cancer)+'/'
            ...
            try:
                ...
                _FOLDER_Cancer_csv_test = '/data/ac1jjgg/Data_Marina/GPy_results/Codes_for_GDSC2_5Cancers/Cancer_'+str(Sel_cancer)+'/'+'N'+str(N_cells)+'/seed'+str(Seed_N)+'/'
                #_FOLDER_Cancer_csc_test = '/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_5Cancers/Models_5Cancers/Cancer_'+str(Sel_cancer)+'/'+'N'+str(N_cells)+'/seed'+str(Seed_N)+'/'
                ...
                IC50_aux = np.mean(np.abs(df_Test_Metrics['IC50_MOGP'].values - df_Test_Metrics['IC50_s4'].values)**2)
...
with open('Test_Metrics_To_Plot.pkl', 'wb') as f:
    pickle.dump([AUC_per_cell,Emax_per_cell,IC50_per_cell,AUCR2_per_cell,EmaxR2_per_cell,IC50R2_per_cell], f)
