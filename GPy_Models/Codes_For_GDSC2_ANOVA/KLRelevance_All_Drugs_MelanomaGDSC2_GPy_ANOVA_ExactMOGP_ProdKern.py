...
# There are only 24 features used in the ANOVA analysis so we stick to those same ones
...
"Best Model: All_Drugs_MelanomaGDSC2_GPy_ANOVA_ExactMOGP_ProdKern.py -i 1500 -s 3.0000 -k 2 -w 1.0000 -r 1011 -p 162 -e %d"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The index below is with response (5)"
##([ 5])

index_Test = np.array([ 5])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    # model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_ANOVA/Best_Model_MelanomaGDSC2_GPy_ANOVA_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_ANOVA/Best_Model_MelanomaGDSC2_GPy_ANOVA_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
relevance = Utils_KLRelevance.KLRelevance_MOGP_GPy(train_x=Xtrain, model=model, delta=1.0e-4,which_p=int(config.feature),diag = False,Use_Cholesky = False, ToSave = True,FileName="MelanomaGDSC2")
