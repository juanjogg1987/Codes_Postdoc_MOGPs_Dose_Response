...
"Best Model: Drug1373_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 3.0000 -k 2 -w 1.0000 -r 1013 -p 236 -e %d"
class commandLine:
    def __init__(self):
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:70 for Mutation"
    "70:328 for PANCAN"
    "328:end for Methylation"
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 3
    AddKern_loc = [70, 328, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1_Final/Best_Model_Drug1373_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1_Final/Best_Model_Drug1373_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
