...
name_for_KLrelevance = 'GDSC1_melanoma_BRAF_9conc_noreps_v2.csv'
...
x_real_dose = np.linspace(0.111111, 1, 9)  #Here is 9 due to using GDSC1 that has 9 doses for Drugs 1036 and 1061
...
"Best Model: Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 1.0000 -k 1 -w 0.1000 -r 1015 -p 603 -e %d"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 1 with response (12), we pick only one to test due to having just 35 datapoints"

index_Test = np.array([12])
...
All_Models = []
Ntasks = 9   #Equal to the number of drug concentrations
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:80 for Mutation"
    "80:352 for PANCAN"
    "352:end for Methylation"
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 3
    AddKern_loc = [80, 352, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1_Final/Best_Model_Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1_Final/Best_Model_Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    x_dose = np.linspace(0.111111, 1.0, 9)  #Here 9 due to having 9 dose responses
