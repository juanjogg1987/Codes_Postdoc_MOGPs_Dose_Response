...
"Best Model: Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_OneKern.py -i 1500 -s 3.0000 -k 1 -w 0.0100 -r 1018 -p 945 -e %d"
class commandLine:
    def __init__(self):
...
for Nfold in range(nsplits,nsplits+1):
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1_Final/Best_Model_Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_OneKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1_Final/Best_Model_Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_OneKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
