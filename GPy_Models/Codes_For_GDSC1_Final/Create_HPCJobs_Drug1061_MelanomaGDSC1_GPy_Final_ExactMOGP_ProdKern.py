...
scales = [0.01,0.1,1,3]
ranks = [1,2,3,4,5,6,7,8,9]   #Since GDSC1 has 9 outputs the maximun rank is 9.
...
path_to_save = './bash_torchjobs_Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern/'
            ...
            for k in ranks:
                ...
                if which_HPC == 'sharc' and count%1 == 0:
                    f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                            "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1_Final/Drug1061_MelanomaGDSC1_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s %.4f -k %d -w %.4f -r %d -p %d" % (
