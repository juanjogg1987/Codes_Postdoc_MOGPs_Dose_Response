...
"Best Model: All_Drugs_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 1.0000 -k 6 -w 0.1000 -r 1011 -p 138"
class commandLine:
    def __init__(self):
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:95 for Mutation"
    "95:389 for PANCAN"
    "389:407 for Methylation"
    "407:end for Drugs data"
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 4
    AddKern_loc = [95, 389, 407, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_Final/Best_Model_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_Final/Best_Model_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
relevance = Utils_KLRelevance.KLRelevance_MOGP_GPy(train_x=Xtrain, model=model, delta=1.0e-7,which_p=int(config.feature),diag = False,Use_Cholesky = False, ToSave = True,FileName="MelanomaGDSC2")
