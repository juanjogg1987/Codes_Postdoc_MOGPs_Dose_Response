...
path_to_save = './bash_torchjobs_Drug1036_MelanomaGDSC2_GPy_Final_ExactMOGP_OneKern/'
            ...
            for k in ranks:
                ...
                if which_HPC == 'sharc' and count%1 == 0:
                    f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                            "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_Final/Drug1036_MelanomaGDSC2_GPy_Final_ExactMOGP_OneKern.py -i 1500 -s %.4f -k %d -w %.4f -r %d -p %d" % (
