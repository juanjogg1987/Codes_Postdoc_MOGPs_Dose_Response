...
"Best Model: Drug1061_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 1.0000 -k 4 -w 1.0000 -r 1013 -p 311 -e %d"
class commandLine:
    def __init__(self):
        ...
        self.which_seed = 1013    #change seed to initialise the hyper-parameters
        self.rank = 4
        self.scale = 1.0
        self.weight = 1.0
        self.bash = "311"
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 1 with response (9) and 1 without reponse (40 i.e., IC50=1.5)"
## ([9,40])

index_Test = np.array([9,40])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:83 for Mutation"
    "83:368 for PANCAN"
    "368:end for Methylation"
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 3
    AddKern_loc = [83, 368, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_Final/Best_Model_Drug1061_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_Final/Best_Model_Drug1061_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
