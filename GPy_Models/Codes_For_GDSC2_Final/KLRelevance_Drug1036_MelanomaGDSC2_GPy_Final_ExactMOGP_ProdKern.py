...
"Best Model: Drug1036_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 3.0000 -k 2 -w 0.1000 -r 1010 -p 71 -e %d"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 1 with response (5) and 1 without reponse (41 i.e., IC50=1.5)"
## ([5,41])

index_Test = np.array([5,41])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:91 for Mutation"
    "91:381 for PANCAN"
    "381:end for Methylation"
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 3
    AddKern_loc = [91, 381, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_Final/Best_Model_Drug1036_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_Final/Best_Model_Drug1036_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
