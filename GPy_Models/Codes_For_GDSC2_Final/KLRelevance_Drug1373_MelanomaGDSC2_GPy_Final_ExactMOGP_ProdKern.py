...
"Best Model: Drug1373_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern.py -i 1500 -s 1.0000 -k 3 -w 0.0100 -r 1011 -p 128 -e %d"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 1 with response (1) and 1 without reponse (43 i.e., IC50=1.5)"
## ([1,43])

index_Test = np.array([1,43])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    "0:74 for Mutation"
    "74:363 for PANCAN"
    "363:end for Methylation"
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    split_dim = 3
    AddKern_loc = [74, 363, Dim]
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC2_Final/Best_Model_Drug1373_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC2_Final/Best_Model_Drug1373_MelanomaGDSC2_GPy_Final_ExactMOGP_ProdKern/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
