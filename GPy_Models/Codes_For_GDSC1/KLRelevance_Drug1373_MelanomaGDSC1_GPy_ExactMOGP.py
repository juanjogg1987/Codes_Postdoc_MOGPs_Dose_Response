...
"BestModel: Drug1373_MelanomaGDSC1_GPy_ExactMOGP.py -i 1500 -s 3.0000 -k 2 -w 0.1000 -r 1019 -p 471"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 1 with response (51) and 1 without reponse (40 i.e., IC50=1.5)"

index_Test = np.array([40,51])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1/Best_Model_Drug1373_MelanomaGDSC1_GPy_ExactMOGP/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/Best_Model_Drug1373_MelanomaGDSC1_GPy_ExactMOGP/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
