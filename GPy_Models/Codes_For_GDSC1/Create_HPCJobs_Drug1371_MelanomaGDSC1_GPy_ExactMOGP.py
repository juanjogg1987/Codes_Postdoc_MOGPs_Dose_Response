...
seeds = [1010,1011,1012,1015,1016,1017,1018,1019,1020]
weights = [0.01,0.1,1.0]
scales = [0.01,0.1,1,3]
ranks = [1,2,3,4,5]   #Since GDSC1 Drug1371 has 5 outputs the maximun rank is 5.
...
path_to_save = './bash_torchjobs_Drug1371_MelanomaGDSC1_GPy_ExactMOGP/'
            ...
            for k in ranks:
                ...
                if which_HPC == 'sharc' and count%1 == 0:
                    f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                            "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/Drug1371_MelanomaGDSC1_GPy_ExactMOGP.py -i 1500 -s %.4f -k %d -w %.4f -r %d -p %d" % (
