...
which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevance_Drug1371_GPy_MelanomaGDSC1/'
if not os.path.exists(path_to_save):
    os.makedirs(path_to_save)


"The winner model should be loaded as"
"KLRelevance_Drug1371_MelanomaGDSC1_GPy_ExactMOGP.py -i 1500 -s 1.0000 -k 3 -w 0.0100 -r 1012 -p 152 -e %d"
"just the -e should be the iterable over the P features"
Pfeatures = 388  #Number of features for Drug1371 in GDSC1
for count in range(Pfeatures):
    f = open(path_to_save + "bash" + str(count) + ".sh", "w+")
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/KLRelevance_Drug1371_MelanomaGDSC1_GPy_ExactMOGP.py -i 1500 -s 1.0000 -k 3 -w 0.0100 -r 1012 -p 152 -e %d" % (
                ram, count))
