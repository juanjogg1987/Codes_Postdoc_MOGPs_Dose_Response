...
which_HPC = 'sharc'
ram = 10
path_to_save = './bash_torchjobs_KLRelevance_Drugs_1036D9_and_1371D5_GPy_MelanomaGDSC1_ToPredict_MelanomaGDSC2/'
if not os.path.exists(path_to_save):
    os.makedirs(path_to_save)


"The winner model should be loaded as"
"KLRelevance_Drugs_1036D9_and_1371D5_MelanomaGDSC1_ToPredict_MelanomaGDSC2.py -i 1500 -s 3.0000 -k 8 -w 0.1000 -r 1010 -p 97 -e %d"
...
for count in range(Pfeatures):
    ...
    if which_HPC == 'sharc' and count%1 == 0:
        f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/KLRelevance_Drugs_1036D9_and_1371D5_MelanomaGDSC1_ToPredict_MelanomaGDSC2.py -i 1500 -s 3.0000 -k 8 -w 0.1000 -r 1010 -p 97 -e %d" % (
                ram, count))
