...
path_to_save = './bash_torchjobs_Drugs_1036D9_and_1371D5_MelanomaGDSC1_GPy_ExactMOGP_SanityCheck/'
            ...
            for k in ranks:
                ...
                if which_HPC == 'sharc' and count%1 == 0:
                    f.write("#!/bin/bash\n#$ -P rse\n#$ -l rmem=%dG #Ram memory\n\n"  
                            "module load apps/python/conda\nsource activate py38_gpflow\npython /home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/Drugs_1036Dose9_and_1371Dose5_MelanomaGDSC1_ToPredict_MelanomaGDSC2_SanityCheck.py -i 1500 -s %.4f -k %d -w %.4f -r %d -p %d" % (
