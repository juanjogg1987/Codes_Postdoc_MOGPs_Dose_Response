...
"BestModel: Drugs_1036Dose9_and_1371Dose5_MelanomaGDSC1_ToPredict_MelanomaGDSC2.py -i 1500 -s 3.0000 -k 8 -w 0.1000 -r 1010 -p 97 -e %d"
class commandLine:
    def __init__(self):
...
for Nfold in range(nsplits,nsplits+1):
    ...
    kern = mykern ** GPy.kern.Coregionalize(1, output_dim=Ntasks9, rank=rank)
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1/Best_Model_Drugs_1036D9_and_1371D5_MelanomaGDSC1_GPy_ExactMOGP_ToPredict_MelanomaGDSC2/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/Best_Model_Drugs_1036D9_and_1371D5_MelanomaGDSC1_GPy_ExactMOGP_ToPredict_MelanomaGDSC2/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
