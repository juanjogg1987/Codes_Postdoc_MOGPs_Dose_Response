...
name_for_KLrelevance = 'GDSC1_melanoma_BRAF_5conc.csv'

df_train_No_MolecForm = pd.read_csv(_FOLDER + name_for_KLrelevance)  # Contain Train dataset prepared by Subhashini-Evelyn
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
df_train_No_MolecForm = df_train_No_MolecForm[(df_train_No_MolecForm["DRUG_ID"]==1371)]
try:
...
"Below we select just 5 concentration since GDSC1 for Drug1373 only has such a number"
...
x_real_dose = np.linspace(0.111111, 1, 5)  #Here is 5 due to using GDSC1 for Drug1373 that has 5 doses
...
"BestModel: Drug1371_MelanomaGDSC1_GPy_ExactMOGP.py -i 1500 -s 1.0000 -k 3 -w 0.0100 -r 1012 -p 152"
class commandLine:
    def __init__(self):
...
config = commandLine()
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"The indexes below are 2 with response (10,160) and 2 without reponse (68, 171 i.e., IC50=1.5)"
##[10,160] [68,171]
index_Test = np.array([10,68,160,171])
...
for Nfold in range(nsplits,nsplits+1):
    ...
    #model[:] = np.load('/home/juanjo/Work_Postdoc/my_codes_postdoc/GPy_Models/Codes_For_GDSC1/Best_Model_Drug1371_MelanomaGDSC1_GPy_ExactMOGP/m_' + m_trained + '.npy')
    model[:] = np.load('/home/ac1jjgg/MOGP_GPy/Codes_for_GDSC1/Best_Model_Drug1371_MelanomaGDSC1_GPy_ExactMOGP/m_' + m_trained + '.npy')
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
